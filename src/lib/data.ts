...
export const aboutContent = {
  paragraphs: [
    "Born and raised in Istanbul, Turkey, I earned my Bachelor of Science in Finance from Adnan Menderes University in January 2015 before moving to the United States and rebuilding my career around software engineering.",
    "I am completing an Associate of Science in Computer Science at City College of San Francisco with a 3.63 GPA, while also finishing certificates in Advanced Web Development Techniques, Web Application Programming, and Front-End Web Development.",
    "My work spans React Native mobile apps, Supabase and PostgreSQL backends, Salesforce Apex and LWC, open-source Python tooling for Dagster, and AI research workflows for evaluating domain-specific LLM behavior.",
  ],
  stats: [
...
export const experiences = [
  {
    ...
    bullets: [
      "Engineered and maintained the full-stack integration between a React Native mobile app, Supabase backend, and Bluehost hosting.",
      "Built cross-platform beacon detection for Android and iOS, strengthening the app's IoT and in-store interaction capabilities.",
...
export const featuredProjects = [
  ...
  },
  {
    ...
    stars: 0,
    url: "",
    highlights: ["Issue #962", "CI Fixes", "Time-Series Tests"],
  ...
  },
  {
    ...
    colabUrl: "https://colab.research.google.com/github/albertfast/lunar_lender_v3/blob/main/lunar_lender_v3.ipynb",
  ...
  },
  {
    ...
    colabUrl: "https://colab.research.google.com/github/albertfast/Mountaincar_v0/blob/main/Mountaincar_v0.ipynb",
