...
export const aboutContent = {
  paragraphs: [
    ...
    "My work spans iOS and Android apps with React Native and Expo Go, Supabase/PostgreSQL and MySQL integrations, Salesforce Sales Cloud, CPQ, Billing Cloud, Apex, LWC, Copado delivery workflows, open-source Python tooling for Dagster, and AI research workflows for evaluating domain-specific LLM behavior.",
  ],
  stats: [
